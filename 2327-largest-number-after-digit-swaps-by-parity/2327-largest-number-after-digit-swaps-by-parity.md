<h1>2327 - Largest Number After Digit Swaps by Parity</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/largest-number-after-digit-swaps-by-parity/">largest-number-after-digit-swaps-by-parity</a></h2><p>You are given a positive integer <code>num</code>. You may swap any two digits of <code>num</code> that have the same <strong>parity</strong> (i.e. both odd digits or both even digits).</p>
