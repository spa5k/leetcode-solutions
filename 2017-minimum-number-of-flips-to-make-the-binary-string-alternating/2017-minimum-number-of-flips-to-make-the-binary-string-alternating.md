<h1>2017 - Minimum Number of Flips to Make the Binary String Alternating</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/">minimum-number-of-flips-to-make-the-binary-string-alternating</a></h2><p>You are given a binary string <code>s</code>. You are allowed to perform two types of operations on the string in any sequence:</p>
